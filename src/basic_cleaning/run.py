...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact", 
        type = str,
        help = "Name for the input W&B artifact",
        required = True
    )
    ...
    parser.add_argument(
        "--min_price", 
        type = float,
        help = "Minimum price boundary (outliers below this are removed)",
        required = True
    )
    ...
    parser.add_argument(
        "--max_price",
        type = float,
        help = "Maximum price boundary (outliers above this are removed)",
        required = True
    )
